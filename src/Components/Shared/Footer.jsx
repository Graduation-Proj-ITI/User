      ...
      <footer>
        <div className="bg-footerBg bg-fixed relative mt-10 py-20 flex justify-between flex-wrap max-sm:px-[1rem] sm:px-[2.5rem] md:px-[3rem] lg:px-[4rem] xl:px-[12rem]">
          ...
          <div className="max-sm:w-10/12 sm:w-5/12 md:w-5/12 lg:w-5/12 xl:w-3/12 xl:ms-5 space-y-5 max-sm:my-5 mt-5">
            <h4 className="font text-primary font-semibold text-xl">
              Quick Links
            </h4>
            <hr className=" w-14 "></hr>
            <ul className=" text-gray-500 font-semibold list-disc px-3">
          ...
          <div className="max-sm:w-10/12 sm:w-5/12 md:w-5/12 lg:w-5/12 xl:w-2/12 xl:ms-5 space-y-5 max-sm:my-5 mt-5">
            ...
            <hr className=" w-14 "></hr>
            <ul className=" text-gray-500 font-semibold list-disc px-3 grid grid-cols-2">
              <li className=" hover:text-secondary hover:translate-x-3 duration-300 cursor-pointer">
                Sofas
              </li>
              <li className=" hover:text-secondary hover:translate-x-3 duration-300 cursor-pointer">
          ...
          <div className="max-sm:w-10/12 sm:w-5/12 md:w-5/12 lg:w-5/12 xl:w-3/12 space-y-5 mt-5">
            <h4 className="font text-primary font-semibold text-xl">Contact</h4>
            <hr className=" w-14 "></hr>

            <div className="flex space-x-2">
              <i className="fa-solid fa-location-dot text-gray-500 py-1"></i>
              <p className=" text-gray-500">
                121 King St, Melbourne den 3000, Australia
              </p>
            </div>
            <div className="group flex space-x-2 cursor-pointer">
              <i className="fa-solid fa-envelope text-gray-500 py-1  group-hover:text-gray-500 duration-300"></i>
              <p className=" text-gray-500  group-hover:text-secondary  duration-300">
                info@example.com
              </p>
            </div>
            <div className="group flex space-x-2 cursor-pointer">
              <i className="fa-solid fa-phone text-gray-500 py-1 group-hover:text-gray-500 duration-300"></i>
              <p className=" text-gray-500 group-hover:text-secondary  duration-300">
                +000 000 0000
              </p>
            </div>
        ...
        <div className="flex flex-wrap bg-bgColor opacity-60 justify-around py-8 ">
          <div className="flex flex-wrap gap-5">
            <a className=" text-gray-500 hover:text-secondary ease-in-out duration-300 cursor-pointer  ">
              Terms of Use
            </a>
            <a className=" text-gray-500 hover:text-secondary ease-in-out duration-300 cursor-pointer ">
              Privacy Policy
